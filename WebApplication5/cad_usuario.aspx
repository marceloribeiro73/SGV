<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="cad_usuario.aspx.cs" Inherits="WebApplication5.cad_usuario" %>
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <div class="form-group col-lg-6">
                                        ...
                                        <asp:TextBox ID="txxVoluntario" CssClass="form-control" runat="server"></asp:TextBox>
                                    </div>
                                    <div class="form-group col-lg-6">
                                    ...
                                    <div class="form-group col-lg-12">
                                        <asp:Button ID="btnSalvar" CssClass="btn btn-success btn-outline" Text="Salvar" runat="server" />
                                        <asp:Button ID="btnCancelar" CssClass="btn btn-danger btn-outline" runat="server" Text="Cancelar" />
                                     </div>
                                </div>
                            </div>
                        </div>
