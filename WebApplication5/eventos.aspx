                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="panel panel-default">
                                ...
                                <asp:GridView ID="grwEventos" runat="server" AutoGenerateColumns="False" DataKeyNames="COD_EVENTO" DataSourceID="evento" CssClass="table table-bordered table-responsive" Width="100%">
                                    <Columns>
                                        <asp:TemplateField>
                                            <ItemTemplate>
