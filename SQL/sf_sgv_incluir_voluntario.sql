...
CREATE PROCEDURE sp_sgv_incluir_voluntario(@cpf VARCHAR(12),@primeiro_Nome VARCHAR(64),@utimo_nome VARCHAR(64),@data_nasc date, @doc_identficacao VARCHAR(15), 
	...
	@bairro VARCHAR(128),@cidade VARCHAR(128), @estado_provincia VARCHAR(128), @pais VARCHAR(128))
AS
BEGIN
  ...
  BEGIN
      ...
      INSERT INTO ENDERECO VALUES (@cpf, @cod_postal, @logradouro, @numero, @complemento,@bairro, @cidade, @estado_provincia, @pais)
  END
